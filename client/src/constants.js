...
export const PLAID_ACCESS_TOKEN_URI = '/plaid/access-token/';
...
// Plaid
export const PLAID_PRODUCT = ['transactions'];
export const PLAID_PUlLIC_TOKEN = 'PLAID_PUlLIC_TOKEN';
...
export const PLAID_GET_TRANSACTIONS_FAILED = 'PLAID_GET_TRANSACTION_FAILED';

export const PLAID_GET_TRANSACTIONS_EACH_SUCCESS =
  'PLAID_GET_TRANSACTIONS_EACH_SUCCESS';
export const PLAID_GET_TRANSACTIONS_EACH_FAILED =
  'PLAID_GET_TRANSACTIONS_EACH_FAILED';

export const PLAID_GET_CATEGORY_SUCCESS = 'PLAID_GET_CATEGORY_SUCCESS';
export const PLAID_GET_CATEGORY_FAILED = 'PLAID_GET_CATEGORY_FAILED';

export const PLAID_GET_NET_WORTH_SUCCESS = 'PLAID_GET_NET_WORTH_SUCCESS';
export const PLAID_GET_NET_WORTH_FAILED = 'PLAID_GET_NET_WORTH_FAILED';

export const PLAID_GET_MONTHLY_EXPENSE_SUCCESS =
